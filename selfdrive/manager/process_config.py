...
procs = [
  ...
  #NativeProcess("logcatd", "system/logcatd", ["./logcatd"], False),
  NativeProcess("proclogd", "system/proclogd", ["./proclogd"], only_onroad),
  #PythonProcess("logmessaged", "system.logmessaged", False),
  ...
  #NativeProcess("loggerd", "system/loggerd", ["./loggerd"], False),
  ...
  #PythonProcess("tombstoned", "selfdrive.tombstoned", False, enabled=not PC),
